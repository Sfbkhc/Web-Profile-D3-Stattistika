<div class="relative w-full h-[140px] bg-fixed bg-center shadow-inner bg-[url('../../../public/img/Bg/Auditorium.jpg')]">
    <div class="absolute inset-0 bg-opacity-50 flex items-center justify-center">
        <h1 class="text-black text-4xl font-semibold">Landasan Kurikulum</h1>
    </div>
</div>
...
<div class="container mx-auto">
    <div class="flex flex-col lg:flex-row items-end lg:items-start w-full max-w-screen-lg mx-auto pt-6 mb-6">
        ...
        <div class="lg:w-3/4 w-full text-justify space-y-2 p-4">
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-[-60px]">
                <!-- Title -->
                ...
                <div class="max-w-2xl mx-auto divide-y divide-gray-200">
                    <div class="py-8 first:pt-0 last:pb-0">
                        <div class="flex gap-x-5">
                            <svg class="shrink-0 mt-1 size-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="grow">
                                ...
                                <p class="mt-1 text-gray-500">
                                    Kurikulum Program Studi D3 Statistika didasarkan pada nilai-nilai filosofis pendidikan yang bertujuan untuk mengembangkan potensi individu secara holistik.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="py-8 first:pt-0 last:pb-0">
                        <div class="flex gap-x-5">
                            ...
                            <div class="grow">
                                ...
                                <p class="mt-1 text-gray-500">
                                    Kurikulum dirancang untuk menjawab kebutuhan masyarakat dalam era digitalisasi, di mana analisis data memegang peran penting dalam pengambilan keputusan.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="py-8 first:pt-0 last:pb-0">
                        <div class="flex gap-x-5">
                            ...
                            <div class="grow">
                                ...
                                <p class="mt-1 text-gray-500">
                                    Kurikulum ini dirancang sesuai
                                    dengan peraturan perundang-undangan yang berlaku di Indonesia, seperti:
                                    Undang - Undang No.20 Tahun 2003 tentang sistem pendidikan Nasional , Peraturan menteri pendidikan dan kebudayaan (Permendikbud) No.3 Tahun 2020 Tentang Standar Nasional Pendidikan Tinggi , Dan Kebijakan Merdeka Belajar - Kampus Mereka (MBKM)
                            </div>
                        </div>
                    </div>
...
<div class="bg-white p-6 rounded-lg text-gray-800 w-full max-w-[1000px] mx-auto mt-2">
    ...
    <div class="bg-gray-100 p-6  rounded-lg p-4 flex items-center">
